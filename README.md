...
A machine learning based system to predict the risk of heart disease and classify patients into Low, Medium and High risk categories using clinical data.
